...
START_LIFTOVER_MS_HG38=`date '+%s'`
	...
	OUTPUT=$CORE_PATH/$PROJECT_MS/MULTI_SAMPLE/$PREFIX".HC.SNP.INDEL.VQSR.GRCh38.LIFTOVER.vcf.gz" \
	REJECT=$CORE_PATH/$PROJECT_MS/MULTI_SAMPLE/$PREFIX".HC.SNP.INDEL.VQSR.GRCh38.LIFTOVER.REJECTED.vcf.gz" \

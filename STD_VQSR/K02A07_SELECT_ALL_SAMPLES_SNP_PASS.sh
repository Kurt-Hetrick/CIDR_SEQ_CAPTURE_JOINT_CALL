...
START_ALL_SNP_PASS=$(date '+%s') # capture time process starts for wall clock tracking purposes.
...
END_ALL_SNP_PASS=$(date '+%s') # capture time process stops for wall clock tracking purposes.

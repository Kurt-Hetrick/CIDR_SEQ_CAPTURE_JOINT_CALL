...
START_LIFTOVER_MS_HG19=$(date '+%s') # capture time process starts for wall clock tracking purposes.
	...
	CMD=${CMD}" OUTPUT=${CORE_PATH}/${PROJECT_MS}/MULTI_SAMPLE/${PREFIX}.FILTERED.GT.REFINED.HG19.LIFTOVER.vcf.gz"
	CMD=${CMD}" REJECT=${CORE_PATH}/${PROJECT_MS}/MULTI_SAMPLE/${PREFIX}.FILTERED.GT.REFINED.HG19.LIFTOVER.REJECTED.vcf.gz"

...
START_LIFTOVER_MS_HG19=`date '+%s'`
	...
	LiftoverVcf \
	INPUT=$CORE_PATH/$PROJECT_MS/MULTI_SAMPLE/$PREFIX".HC.SNP.INDEL.VQSR.vcf.gz" \
	OUTPUT=$CORE_PATH/$PROJECT_MS/MULTI_SAMPLE/$PREFIX".HC.SNP.INDEL.VQSR.HG19.LIFTOVER.vcf.gz" \
	REJECT=$CORE_PATH/$PROJECT_MS/MULTI_SAMPLE/$PREFIX".HC.SNP.INDEL.VQSR.HG19.LIFTOVER.REJECTED.vcf.gz" \

...
############################################################################################
	...
	mkdir -p ${CORE_PATH}/${PROJECT_MS}/LOGS/{G01A01A01_LIFTOVER_INITIAL_HG19_TO_HG38,I02A01_LIFTOVER_GRCH38_REFINED}
	...
	# Breakout the snps
		...
		# APPLY HARD FILTERS TO SNPS
			...
			HARD_FILTER_SNV ()
			{
				...
				${COMMON_HARD_FILTER_SCRIPT_DIR}/E01-A01_FILTER_SNV.sh \
					${JAVA_1_8} \
					${GATK_DIR} \
					${REF_GENOME} \
					${CORE_PATH} \
...
##################################################
	...
	# liftover refined genotypes from hg19 to grch38
		...
		LIFTOVER_HG19_TO_GRCH38_REFINED_ANNOTATED ()
		{
			...
			${SCRIPT_DIR}/I02A01_REFINED_LIFTOVER_VARIANTS_HG19_TO_GRCH38.sh \

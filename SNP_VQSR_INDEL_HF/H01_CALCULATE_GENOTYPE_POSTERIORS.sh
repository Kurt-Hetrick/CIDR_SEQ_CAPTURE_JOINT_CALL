...
CMD=$CMD' --variant '$CORE_PATH'/'$PROJECT_MS'/MULTI_SAMPLE/'$PREFIX'.VQSR.SNP.HardFiltered.INDEL.vcf.gz'
CMD=$CMD' -o '$CORE_PATH'/'$PROJECT_MS'/TEMP/'$PREFIX'.'$BED_FILE_NAME'.BEDsuperset.VQSR.SNP.HardFiltered.INDEL.1KG.ExAC3.REFINED.temp.vcf.gz'

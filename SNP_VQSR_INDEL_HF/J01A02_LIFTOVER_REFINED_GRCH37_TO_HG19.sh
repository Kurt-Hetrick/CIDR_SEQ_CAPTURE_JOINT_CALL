...
START_LIFTOVER_MS_HG19=`date '+%s'`
	...
	LiftoverVcf \
	INPUT=$CORE_PATH/$PROJECT_MS/TEMP/$PREFIX".BEDsuperset.VQSR.SNP.HardFiltered.INDEL.1KG.ExAC3.REFINED.vcf" \
	OUTPUT=$CORE_PATH/$PROJECT_MS/MULTI_SAMPLE/$PREFIX".BEDsuperset.VQSR.SNP.HardFiltered.INDEL.1KG.ExAC3.REFINED.HG19.LIFTOVER.vcf.gz" \
	REJECT=$CORE_PATH/$PROJECT_MS/MULTI_SAMPLE/$PREFIX".BEDsuperset.VQSR.SNP.HardFiltered.INDEL.1KG.ExAC3.REFINED.HG19.LIFTOVER.REJECTED.vcf.gz" \

...
START_HAPMAP_SNP_PASS=$(date '+%s') # capture time process starts for wall clock tracking purposes.
...
# construct command line
	...
	CMD=${CMD}" --output ${CORE_PATH}/${PROJECT_MS}/MULTI_SAMPLE/VARIANT_SUMMARY_STAT_VCF/${PREFIX}.FILTERED.GT.REFINED.SNP.HAPMAP.SAMPLES.PASS.vcf"
...
END_HAPMAP_SNP_PASS=$(date '+%s') # capture time process stops for wall clock tracking purposes.

...
CMD=$CMD' -out '$CORE_PATH'/'$PROJECT_MS'/TEMP/'$PREFIX'.BEDsuperset.VQSR.SNP.HardFiltered.INDEL.1KG.ExAC3.REFINED.vcf'
...
ls $CORE_PATH/$PROJECT_MS/TEMP/$PREFIX".BEDsuperset.VQSR.SNP.HardFiltered.INDEL.1KG.ExAC3.REFINED.vcf.idx"

...
# construct cmd line
	...
	CMD=${CMD}" OUTPUT=${CORE_PATH}/${PROJECT_MS}/MULTI_SAMPLE/${PREFIX}.FILTERED.HG19.LIFTOVER.vcf.gz"
	CMD=${CMD}" REJECT=${CORE_PATH}/${PROJECT_MS}/MULTI_SAMPLE/${PREFIX}.FILTERED.HG19.LIFTOVER.REJECTED.vcf.gz"

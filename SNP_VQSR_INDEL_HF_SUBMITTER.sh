...
###########################
	...
	# CHANGE SCRIPT DIR TO WHERE YOU HAVE HAVE THE SCRIPTS BEING SUBMITTED
		...
		SCRIPT_DIR="${SUBMITTER_SCRIPT_PATH}/SNP_VQSR_INDEL_HF"
		...
		COMMON_HARD_FILTER_SCRIPT_DIR="${SUBMITTER_SCRIPT_PATH}/COMMON_HARD_FILTER_SCRIPTS"
...
#########################################################
	...
	# Breakout the snps
		...
		EXTRACT_SNV ()
		{
			...
			${COMMON_HARD_FILTER_SCRIPT_DIR}/E01_EXTRACT_SNV.sh \
				${JAVA_1_8} \
				${GATK_DIR} \
				${REF_GENOME} \
				${CORE_PATH} \
	...
	# apply the snp vqsr model to the full vcf
		...
		APPLY_RECALIBRATION_SNV ()
		{
			...
			-N E01-A01-A01_APPLY_RECALIBRATION_SNV_${PROJECT_MS} \
				...
				-hold_jid E01-A01_VARIANT_RECALIBRATOR_SNV_${PROJECT_MS} \
		...
		EXTRACT_INDEL_AND_MIXED ()
			{
				...
				-N E02_EXTRACT_INDEL_AND_MIXED_${PROJECT_MS} \
					...
					-hold_jid D01_CAT_VARIANTS_${PROJECT_MS} \
				${COMMON_HARD_FILTER_SCRIPT_DIR}/E02_EXTRACT_INDELS_AND_MIXED.sh \
					${JAVA_1_8} \
					${GATK_DIR} \
					${REF_GENOME} \
					${CORE_PATH} \
		...
		HARD_FILTER_INDEL_AND_MIXED ()
			{
					...
					${COMMON_HARD_FILTER_SCRIPT_DIR}/E02-A01_FILTER_INDELS_AND_MIXED.sh \
						${JAVA_1_8} \
						${GATK_DIR} \
						${REF_GENOME} \
						${CORE_PATH} \
		...
		COMBINE_SNV_INDEL_VARIANTS ()
			{
				...
				${COMMON_HARD_FILTER_SCRIPT_DIR}/F01_COMBINE_VARIANTS.sh \
						${JAVA_1_8} \
						${GATK_DIR} \
						${REF_GENOME} \
						${CORE_PATH} \
	...
	# liftover initial hg19 vcf to grch38
		...
		LIFTOVER_INITIAL_HG19_VCF_TO_HG38 ()
		{
				...
				qsub \
					...
					-p ${PRIORITY} \
					-j y \
				-N G01A01_LIFTOVER_INITIAL_HG19_TO_GRCH38_${PROJECT_MS} \
					-o ${CORE_PATH}/${PROJECT_MS}/LOGS/G01A01_LIFTOVER_INITIAL_HG19_TO_HG38.log \
					-hold_jid G01_LIFTOVER_INITIAL_GRCH37_TO_HG19_${PROJECT_MS} \

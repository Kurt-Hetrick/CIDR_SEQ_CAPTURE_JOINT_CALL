...
###########################
	...
	# CHANGE SCRIPT DIR TO WHERE YOU HAVE HAVE THE SCRIPTS BEING SUBMITTED
		...
		HARD_FILTER_SCRIPT_DIR="${SUBMITTER_SCRIPT_PATH}/HARD_FILTER_ALL"
...
#########################################################
	...
	# Breakout the snps
		...
		EXTRACT_SNV ()
		{
			...
			${HARD_FILTER_SCRIPT_DIR}/E01_EXTRACT_SNV.sh \
				${JAVA_1_8} \
				${GATK_DIR} \
				${REF_GENOME} \
				${CORE_PATH} \
		...
		EXTRACT_INDEL_AND_MIXED ()
			{
				...
				-N E02_EXTRACT_INDEL_AND_MIXED_${PROJECT_MS} \
					...
					-hold_jid D01_CAT_VARIANTS_${PROJECT_MS} \
				${HARD_FILTER_SCRIPT_DIR}/E02_EXTRACT_INDELS_AND_MIXED.sh \
					${JAVA_1_8} \
					${GATK_DIR} \
					${REF_GENOME} \
					${CORE_PATH} \
		...
		HARD_FILTER_INDEL_AND_MIXED ()
			{
					...
					${HARD_FILTER_SCRIPT_DIR}/E02-A01_FILTER_INDELS_AND_MIXED.sh \
						${JAVA_1_8} \
						${GATK_DIR} \
						${REF_GENOME} \
						${CORE_PATH} \
		...
		COMBINE_SNV_INDEL_VARIANTS ()
			{
				...
				${HARD_FILTER_SCRIPT_DIR}/F01_COMBINE_VARIANTS.sh \
						${JAVA_1_8} \
						${GATK_DIR} \
						${REF_GENOME} \
						${CORE_PATH} \

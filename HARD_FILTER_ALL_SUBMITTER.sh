...
###########################
	...
	# CHANGE SCRIPT DIR TO WHERE YOU HAVE HAVE THE SCRIPTS BEING SUBMITTED
		...
		SCRIPT_DIR="${SUBMITTER_SCRIPT_PATH}/COMMON_HARD_FILTER_SCRIPTS"
...
############################################################################################
	...
	mkdir -p ${CORE_PATH}/${PROJECT_MS}/TEMP/{BED_FILE_SPLIT,AGGREGATE,QC_REPORT_PREP_${PREFIX},SPLIT_LIST,ANNOVAR/${PROJECT_MS}}

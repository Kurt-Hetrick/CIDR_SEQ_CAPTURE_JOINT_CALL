		...
		EXTRACT_INDEL_AND_MIXED ()
			{
				...
				-N E02_EXTRACT_INDEL_AND_MIXED_$PROJECT_MS \
					...
					-hold_jid D01_CAT_VARIANTS_$PROJECT_MS \
				$SCRIPT_DIR/E02_EXTRACT_INDEL_AND_MIXED.sh \
					$JAVA_1_8 \
					$GATK_DIR \
					$REF_GENOME \
					$CORE_PATH \
			...
			HARD_FILTER_INDEL_AND_MIXED ()
				{
					...
					$SCRIPT_DIR/E01-A01_FILTER_INDEL_MIXED.sh \
						$JAVA_1_8 \
						$GATK_DIR \
						$REF_GENOME \
						$CORE_PATH \
		...
		COMBINE_SNV_INDEL_VARIANTS ()
			{
				...
				-N F01_COMBINE_VARIANTS_$PROJECT_MS \
					-o $CORE_PATH/$PROJECT/LOGS/F01_COMBINE_VARIANTS.log \
